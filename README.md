...
- [Latest Visual Studio Community 2022/2026](https://visualstudio.microsoft.com/insiders/) (17.14.27/18.3.2 +)
...
On first use of the stem splitter, the app will automatically download the `htdemucs_ort_v1` model (~200 MB) to your system's app data directory. This should only happen once. 
