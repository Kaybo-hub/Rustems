...
export default function App() {
  ...
  const handlePickAndLoad = async () => {
    ...
    // Pre-fill track name from folder name, user can edit
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      setConnected(true)
      // Auto-fetch track listing immediately after connecting
      await fetchTracks()
    } catch (err) {
    ...
    <div style={{ padding: 40, fontFamily: "sans-serif", maxWidth: 800 }}>
      ...
      <section style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          ...
          {connected && (
            <button onClick={fetchTracks} disabled={loadingTracks}>
